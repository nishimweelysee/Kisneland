...
class GameDetails extends Component {
  ...
  componentDidMount() {
    console.log(this.props.game.included)
  }
        ...
        <div className="container-bg bg-dark-blue">
          <div className="container">
            <div className="gallery-filter-area row">
              ...
              <div className="tp-gallery-item col-md-5 col-sm-6 mb-10">
                <div className="tp-gallery-item-img">
                  <div className="thumbnails">
                    <img src={publicUrl + 'photo/' + this.props.game.mainPhoto} alt="image" />
              ...
              {
                this.props.game.photos.map((photo, index) => (
              ...
              <div className="col-xl-3 col-lg-4">
                <div className="details">
                  ...
                  <div className="tp-review-meta">
                    ...
                    <i className="ic-yellow fa fa-star" />
                    <i className="ic-yellow fa fa-star" />
                    <span>{this.props.game.review}</span>
                  </div>
              ...
              <div className="col-xl-9 col-lg-8">
                <div className="book-list-warp">
                  ...
                  <div className="tp-price-meta">
                    <p>Price</p>
                    <h2>{this.props.game.price}... <small>   CFA</small></h2>
                  </div>
                </div>
                <ul className="tp-list-meta border-tp-solid">
                  ...
                  <li><i className="fa fa-star" /> {this.props.game.review}</li>
                </ul>
              </div>
            </div>
          </div>
                    ...
                    games.map(g => (
                      <div key={g.id} className="col-lg-4 col-md-4">
                        <div className="single-blog">
                          <div className="thumb">
                            <img src={publicUrl + "photo/" + g.mainPhoto} alt="blog" />
                          </div>
